...
import { Home, Intro1, Register, Login, Result1, Result2, Result3, Intro2, Intro3, Intro4, Intro5, ResetPassword, NewPassword, Dashboard, Landing, DetailsForm1, DetailsForm2 } from "./Components/index.js";
const App = () => {
  return (
    <Router>
      <Switch>
