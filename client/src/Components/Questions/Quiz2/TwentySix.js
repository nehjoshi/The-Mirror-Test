...
const Quiz2TwentySix = () => {
    ...
    const handleRes = (ans) => {
        ...
        const data = { ans, result, type: 2, done: false, email: localStorage.getItem("email"), qno: 26 }
    ...
    return loading ? (
        ...
        <Grid container className={classes.wrapper}>
            <Grid className={classes.box} ref={mainRef}>
                ...
                Sometimes, I over-function, over-adapt, over-accommodate others, or over-apologize for things I didn’t do, in an attempt to stabilize connection.            </p>
