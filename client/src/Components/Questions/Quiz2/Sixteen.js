    ...
    return loading ? (
        ...
        <Grid container className={classes.wrapper}>
            <Grid className={classes.box} ref={mainRef}>
                <h1 className={classes.heading}>Question 16</h1>
                <p className={classes.text} style={{ marginTop: '30px' }}>
                When I reach a certain level of intimacy with my partner, I sometimes
experience inexplicable fear.                </p>
