...
const Quiz2TwentyTwo = () => {
    ...
    const handleRes = (ans) => {
        ...
        const data = { ans, result, type: 2, done: false, email: localStorage.getItem("email"), qno: 22 }
    ...
    return loading ? (
        ...
        <Grid container className={classes.wrapper}>
            <Grid className={classes.box} ref={mainRef}>
                ...
                It is difficult for me to say NO or to set realistic boundaries.          </p>
