...
const Quiz2ThirtyFive = () => {
    ...
    const handleRes = (ans) => {
        ...
        const data = { ans, result, type: 3, done: false, email: localStorage.getItem("email"), qno: 35 }
    ...
    return loading ? (
        ...
        <Grid container className={classes.wrapper}>
            <Grid className={classes.box} ref={mainRef}>
                ...
                When I lose a relationship, at first I might experience separation elation and then become depressed.           </p>
...
export default Quiz2ThirtyFive;
