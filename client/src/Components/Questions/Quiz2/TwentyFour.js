...
const Quiz2TwentyFour = () => {
  ...
  const data = { ans, result, type: 4, done: false, email: localStorage.getItem("email") }
        axios.post("https://self-growth-questionaire.herokuapp.comquiz2", data)
            .then((response) => {
    ...
    return loading ? (
        ...
        <Grid container className={classes.wrapper}>
            <Grid className={classes.box} ref={mainRef}>
                <h1 className={classes.heading}>Question 24</h1>
                <p className={classes.text} style={{ marginTop: '30px' }}>
                Stuck in approach-avoidance patterns with my partner, I want closeness but am also afraid of the one I desire to be close with.            </p>
...
export default Quiz2TwentyFour;
