...
const Quiz2ThirtySeven = () => {
    ...
    const handleRes = (ans) => {
        ...
        const data = { ans, result, type: 1, done: false, email: localStorage.getItem("email"), qno: 37 }
    ...
    return loading ? (
        ...
        <Grid container className={classes.wrapper}>
            <Grid className={classes.box} ref={mainRef}>
                <h1 className={classes.heading}>Question 37</h1>
...
export default Quiz2ThirtySeven;
