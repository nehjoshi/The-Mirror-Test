    ...
    return loading ? (
        ...
        <Grid container className={classes.wrapper}>
            <Grid className={classes.box} ref={mainRef}>
                ...
                Protection often feels out of reach. I struggle to feel safe with my partner.           </p>
...
export default Quiz2TwentyEight;
