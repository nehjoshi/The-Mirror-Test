...
const Quiz2Eleven = () => {
    ...
    const handleRes = (ans) => {
        ...
        const data = { ans, result, type: 3, done: false, email: localStorage.getItem("email"), qno: 11 }
    ...
    return loading ? (
        ...
        <Grid container className={classes.wrapper}>
            <Grid className={classes.box} ref={mainRef}>
                ...
                When my partner arrives home or approaches me, I feel
inexplicably stressed – especially when he or she wants to connect.
                </p>
