...
const Quiz2ThirtyNine = () => {
    ...
    const handleRes = (ans) => {
        ...
        const data = { ans, result, type: 3, done: false, email: localStorage.getItem("email"), qno: 39 }
    ...
    return loading ? (
        ...
        <Grid container className={classes.wrapper}>
            <Grid className={classes.box} ref={mainRef}>
                ...
                I often find eye contact uncomfortable and particularly difficult to maintain.           </p>
...
export default Quiz2ThirtyNine;
