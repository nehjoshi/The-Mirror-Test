...
const Quiz2ThirtyOne = () => {
    ...
    const handleRes = (ans) => {
        ...
        const data = { ans, result, type: 3, done: false, email: localStorage.getItem("email"), qno: 31 }
    ...
    return loading ? (
        ...
        <Grid container className={classes.wrapper}>
            <Grid className={classes.box} ref={mainRef}>
                ...
                I find myself minimizing the importance of close relationships in my life.           </p>
