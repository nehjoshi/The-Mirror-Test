...
const Quiz2TwentyOne = () => {
    ...
    const handleRes = (ans) => {
        ...
        const data = { ans, result, type: 1, done: false, email: localStorage.getItem("email"), qno: 21 }
    ...
    return loading ? (
        ...
        <Grid container className={classes.wrapper}>
            <Grid className={classes.box} ref={mainRef}>
                ...
                I find it easy to flow between being close and connected with my partner to being on my own.            </p>
