    ...
    return loading ? (
        ...
        <Grid container className={classes.wrapper}>
            <Grid className={classes.box} ref={mainRef}>
                ...
                I insist on self-reliance; I have difficulty reaching out when I need help,
and I do many of life’s tasks or my hobbies, alone.            </p>
