...
const Quiz2TwentyNine = () => {
    ...
    const handleRes = (ans) => {
        ...
        const data = { ans, result, type: 1, done: false, email: localStorage.getItem("email"), qno: 29 }
    ...
    return loading ? (
        ...
        <Grid container className={classes.wrapper}>
            <Grid className={classes.box} ref={mainRef}>
                ...
                I look at my partner with kindness and caring and look forward to our time together.           </p>
...
export default Quiz2TwentyNine;
