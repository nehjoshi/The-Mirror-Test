...
const Quiz3_39 = () => {
    ...
    const handleRes = (type, ans) => {
        ...
        const data = { type, value: ans, result, done: false, email: localStorage.getItem("email"), qno: 39 }
    ...
    return loading ? (
        ...
        <Grid container className={classes.wrapper}>
            <Grid className={classes.box} ref={mainRef}>
                <h1 className={classes.heading}>Question 39</h1>
                <p className={classes.text} style={{ marginTop: '30px' }}>
                    Your doctor tells you that you eat too much sugar.
                </p>
                <div className={classes.buttonWrapper}>
                    <div className={classes.button} onClick={() => handleRes('psb', 1)}>A. I don't pay much attention to my diet.</div>
                    <div className={classes.button} onClick={() => handleRes('psb', 0)}>B. You can't avoid sugar, it's in everything.</div>
                </div>
