...
const Quiz3_8 = () => {
    ...
    const handleRes = (type, ans) => {
        ...
        const data = {type, value: ans, result, done: false, email: localStorage.getItem("email"), qno: 8}
        ...
        <Grid container className={classes.wrapper}>
            <Grid className={classes.box} ref={mainRef}>
                ...
                <div className={classes.buttonWrapper}>
                    <div className={classes.button} onClick={() => handleRes('pvb', 1)}>A. Sometimes my memory fails me.</div>
                    <div className={classes.button} onClick={() => handleRes('pvb', 0)}>B. I sometimes forget to check my appointment book.</div>
                </div>
