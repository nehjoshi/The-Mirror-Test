...
const Quiz3_35 = () => {
    ...
    const handleRes = (type, ans) => {
        ...
        const data = { type, value: ans, result, done: false, email: localStorage.getItem("email"), qno: 35 }
    ...
    return loading ? (
        ...
        <Grid container className={classes.wrapper}>
            <Grid className={classes.box} ref={mainRef}>
                <h1 className={classes.heading}>Question 35</h1>
                <p className={classes.text} style={{ marginTop: '30px' }}>
                    A friend thanks you for helping him/her get through a bad time.
                </p>
                <div className={classes.buttonWrapper}>
                    <div className={classes.button} onClick={() => handleRes('psb', 1)}>A. I enjoy helping him/her through tough times.</div>
                    <div className={classes.button} onClick={() => handleRes('psb', 0)}>B. I care about people.</div>
                </div>
