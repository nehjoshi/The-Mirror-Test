...
const Quiz3_21 = () => {
    ...
    const handleRes = (type, ans) => {
        ...
        const data = { type, value: ans, result, done: false, email: localStorage.getItem("email"), qno: 21 }
    ...
    return loading ? (
        ...
        <Grid container className={classes.wrapper}>
            <Grid className={classes.box} ref={mainRef}>
                <h1 className={classes.heading}>Question 21</h1>
                <p className={classes.text} style={{ marginTop: '30px' }}>
                    You are penalized for not returning your income-tax forms on time.
                </p>
                <div className={classes.buttonWrapper}>
                    <div className={classes.button} onClick={() => handleRes('pmb', 1)}>A. I always put off doing my taxes.</div>
                    <div className={classes.button} onClick={() => handleRes('pmb', 0)}>B. I was lazy about getting my taxes done this year.</div>
                </div>
