...
const Quiz3_6 = () => {
    ...
    const handleRes = (type, ans) => {
        ...
        const data = {type, value: ans, result, done: false, email: localStorage.getItem("email"), qno: 6}
        ...
        <Grid container className={classes.wrapper}>
            <Grid className={classes.box} ref={mainRef}>
                ...
                <div className={classes.buttonWrapper}>
                    <div className={classes.button} onClick={() => handleRes('pvg', 0)}>A. I'm attractive to him/her.</div>
                    <div className={classes.button} onClick={() => handleRes('pvg', 1)}>B. I am a popular person.</div>
                </div>
