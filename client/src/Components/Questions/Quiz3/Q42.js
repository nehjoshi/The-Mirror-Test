...
const Quiz3_42 = () => {
    ...
    const handleRes = (type, ans) => {
        ...
        const data = { type, value: ans, result, done: false, email: localStorage.getItem("email"), qno: 42 }
        ...
        <Grid container className={classes.wrapper}>
            <Grid className={classes.box} ref={mainRef}>
                ...
                <div className={classes.buttonWrapper}>
                    <div className={classes.button} onClick={() => handleRes('pmb', 1)}>A. Skiing is difficult.</div>
                    <div className={classes.button} onClick={() => handleRes('pmb', 0)}>B. The trails were icy.</div>
                </div>
