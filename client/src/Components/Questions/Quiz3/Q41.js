...
const Quiz3_41 = () => {
    ...
    const handleRes = (type, ans) => {
        ...
        const data = { type, value: ans, result, done: false, email: localStorage.getItem("email"), qno: 41 }
    ...
    return loading ? (
        ...
        <Grid container className={classes.wrapper}>
            <Grid className={classes.box} ref={mainRef}>
                <h1 className={classes.heading}>Question 41</h1>
                ...
                <div className={classes.buttonWrapper}>
                    <div className={classes.button} onClick={() => handleRes('psb', 1)}>A. I have been feeling cranky and pressured lately.</div>
                    <div className={classes.button} onClick={() => handleRes('psb', 0)}>B. He/she has been hostile lately.</div>
                </div>
