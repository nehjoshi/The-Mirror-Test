...
const Quiz3_45 = () => {
    ...
    const handleRes = (type, ans) => {
        ...
        const data = { type, value: ans, result, done: false, email: localStorage.getItem("email"), qno: 45 }
    ...
    return loading ? (
        ...
        <Grid container className={classes.wrapper}>
            <Grid className={classes.box} ref={mainRef}>
                <h1 className={classes.heading}>Question 45</h1>
                <p className={classes.text} style={{ marginTop: '30px' }}>
                    You win the lottery.
                </p>
                <div className={classes.buttonWrapper}>
                    <div className={classes.button} onClick={() => handleRes('psg', 0)}>A. It was pure chance.</div>
                    <div className={classes.button} onClick={() => handleRes('psg', 1)}>B. I picked the right numbers.</div>
                </div>
