...
const Quiz3_24 = () => {
    ...
    const handleRes = (type, ans) => {
        ...
        const data = { type, value: ans, result, done: false, email: localStorage.getItem("email"), qno: 24 }
        ...
        <Grid container className={classes.wrapper}>
            <Grid className={classes.box} ref={mainRef}>
                ...
                <div className={classes.buttonWrapper}>
                    <div className={classes.button} onClick={() => handleRes('pmg', 1)}>A. I am outgoing at parties.</div>
                    <div className={classes.button} onClick={() => handleRes('pmg', 0)}>B. I was in perfect form last night.</div>
                </div>
