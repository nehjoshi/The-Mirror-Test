...
const Quiz3_18 = () => {
    ...
    const handleRes = (type, ans) => {
        ...
        const data = { type, value: ans, result, done: false, email: localStorage.getItem("email"), qno: 18 }
        ...
        <Grid container className={classes.wrapper}>
            <Grid className={classes.box} ref={mainRef}>
                ...
                <div className={classes.buttonWrapper}>
                    <div className={classes.button} onClick={() => handleRes('pvb', 1)}>A. I'm not very athletic.</div>
                    <div className={classes.button} onClick={() => handleRes('pvb', 0)}>B. I'm not good at that sport.</div>
                </div>
