...
const Quiz3_22 = () => {
    ...
    const handleRes = (type, ans) => {
        ...
        const data = { type, value: ans, result, done: false, email: localStorage.getItem("email"), qno: 22 }
        ...
        <Grid container className={classes.wrapper}>
            <Grid className={classes.box} ref={mainRef}>
                ...
                <div className={classes.buttonWrapper}>
                    <div className={classes.button} onClick={() => handleRes('pvb', 1)}>A. I was a wreck that day.</div>
                    <div className={classes.button} onClick={() => handleRes('pvb', 0)}>B. I I got tongue-tied when I asked him/her on the date.</div>
                </div>
