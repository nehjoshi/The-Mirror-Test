...
const Quiz3_12 = () => {
    ...
    const handleRes = (type, ans) => {
        ...
        const data = {type, value: ans, result, done: false, email: localStorage.getItem("email"), qno: 12}
    ...
    return loading ? (
        ...
        <Grid container className={classes.wrapper}>
            <Grid className={classes.box} ref={mainRef}>
                <h1 className={classes.heading}>Question 12</h1>
                <p className={classes.text} style={{ marginTop: '30px' }}>
                You were extremely healthy all year.
                </p>
                <div className={classes.buttonWrapper}>
                    <div className={classes.button} onClick={() => handleRes('psg', 0)}>A. Few people around me were sick, so I wasn't exposed.</div>
                    <div className={classes.button} onClick={() => handleRes('psg', 1)}>B. I made sure I ate well and got enough rest.</div>
                </div>
