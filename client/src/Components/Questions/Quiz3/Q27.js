...
const Quiz3_27 = () => {
    ...
    const handleRes = (type, ans) => {
        ...
        const data = { type, value: ans, result, done: false, email: localStorage.getItem("email"), qno: 27 }
        ...
        <Grid container className={classes.wrapper}>
            <Grid className={classes.box} ref={mainRef}>
                ...
                <div className={classes.buttonWrapper}>
                    <div className={classes.button} onClick={() => handleRes('psg', 0)}>A. The joke was funny.</div>
                    <div className={classes.button} onClick={() => handleRes('psg', 1)}>B. My timing was perfect.</div>
                </div>
