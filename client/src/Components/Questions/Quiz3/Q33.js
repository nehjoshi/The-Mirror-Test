...
const Quiz3_33 = () => {
    ...
    const handleRes = (type, ans) => {
        ...
        const data = { type, value: ans, result, done: false, email: localStorage.getItem("email"), qno: 33 }
    ...
    return loading ? (
        ...
        <Grid container className={classes.wrapper}>
            <Grid className={classes.box} ref={mainRef}>
                <h1 className={classes.heading}>Question 33</h1>
                <p className={classes.text} style={{ marginTop: '30px' }}>
                    A friend says something that hurts your feelings.
                </p>
                <div className={classes.buttonWrapper}>
                    <div className={classes.button} onClick={() => handleRes('pmb', 1)}>A. He/she always blurts things out without thinking of others.</div>
                    <div className={classes.button} onClick={() => handleRes('pmb', 0)}>B. My friend was in a bad mood and took it out on me.</div>
                </div>
