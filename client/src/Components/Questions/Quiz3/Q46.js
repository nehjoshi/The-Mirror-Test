...
const Quiz3_46 = () => {
    ...
    const handleRes = (type, ans) => {
        ...
        const data = { type, value: ans, result, done: false, email: localStorage.getItem("email"), qno: 46 }
    ...
    return loading ? (
        ...
        <Grid container className={classes.wrapper}>
            <Grid className={classes.box} ref={mainRef}>
                <h1 className={classes.heading}>Question 46</h1>
                <p className={classes.text} style={{ marginTop: '30px' }}>
                    You gain weight over the holidays and you can't lose it.
                </p>
                <div className={classes.buttonWrapper}>
                    <div className={classes.button} onClick={() => handleRes('pmb', 1)}>A. Diets don't work in the long run.</div>
                    <div className={classes.button} onClick={() => handleRes('pmb', 0)}>B. The diet I tried didn't work.</div>
                </div>
