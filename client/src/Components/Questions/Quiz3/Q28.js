...
const Quiz3_28 = () => {
    ...
    const handleRes = (type, ans) => {
        ...
        const data = { type, value: ans, result, done: false, email: localStorage.getItem("email"), qno: 28 }
    ...
    return loading ? (
        ...
        <Grid container className={classes.wrapper}>
            <Grid className={classes.box} ref={mainRef}>
                <h1 className={classes.heading}>Question 28</h1>
                ...
                <div className={classes.buttonWrapper}>
                    <div className={classes.button} onClick={() => handleRes('pvg', 0)}>A. I am good at my job.</div>
                    <div className={classes.button} onClick={() => handleRes('pvg', 1)}>B. I am an efficient person.</div>
                </div>
