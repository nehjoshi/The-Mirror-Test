...
const Quiz3_34 = () => {
    ...
    const handleRes = (type, ans) => {
        ...
        const data = { type, value: ans, result, done: false, email: localStorage.getItem("email"), qno: 34 }
        ...
        <Grid container className={classes.wrapper}>
            <Grid className={classes.box} ref={mainRef}>
                ...
                <div className={classes.buttonWrapper}>
                    <div className={classes.button} onClick={() => handleRes('pvg', 0)}>A. I am an expert in the area about which I was asked.</div>
                    <div className={classes.button} onClick={() => handleRes('pvg', 1)}>B. I am good at giving useful advice.</div>
                </div>
