...
const Quiz3_26 = () => {
    ...
    const handleRes = (type, ans) => {
        ...
        const data = { type, value: ans, result, done: false, email: localStorage.getItem("email"), qno: 26 }
    ...
    return loading ? (
        ...
        <Grid container className={classes.wrapper}>
            <Grid className={classes.box} ref={mainRef}>
                <h1 className={classes.heading}>Question 26</h1>
                <p className={classes.text} style={{ marginTop: '30px' }}>
                    You do exceptionally well in a job interview.
                </p>
                <div className={classes.buttonWrapper}>
                    <div className={classes.button} onClick={() => handleRes('pmg', 0)}>A. I felt extremely confident during the interview.</div>
                    <div className={classes.button} onClick={() => handleRes('pmg', 1)}>B. I interview well.</div>
                </div>
