...
const Quiz3_43 = () => {
    ...
    const handleRes = (type, ans) => {
        ...
        const data = { type, value: ans, result, done: false, email: localStorage.getItem("email"), qno: 43 }
    ...
    return loading ? (
        ...
        <Grid container className={classes.wrapper}>
            <Grid className={classes.box} ref={mainRef}>
                <h1 className={classes.heading}>Question 43</h1>
                <p className={classes.text} style={{ marginTop: '30px' }}>
                    You win a prestigious award.
                </p>
                <div className={classes.buttonWrapper}>
                    <div className={classes.button} onClick={() => handleRes('pvg', 0)}>A. I solved an important problem.</div>
                    <div className={classes.button} onClick={() => handleRes('pvg', 1)}>B. I was the best employee.</div>
                </div>
