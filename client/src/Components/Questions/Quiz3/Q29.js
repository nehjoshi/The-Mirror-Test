...
const Quiz3_29 = () => {
    ...
    const handleRes = (type, ans) => {
        ...
        const data = { type, value: ans, result, done: false, email: localStorage.getItem("email"), qno: 29 }
    ...
    return loading ? (
        ...
        <Grid container className={classes.wrapper}>
            <Grid className={classes.box} ref={mainRef}>
                <h1 className={classes.heading}>Question 29</h1>
                <p className={classes.text} style={{ marginTop: '30px' }}>
                    You've been feeling run-down lately.
                </p>
                <div className={classes.buttonWrapper}>
                    <div className={classes.button} onClick={() => handleRes('pmb', 1)}>A. I never get a chance to relax.</div>
                    <div className={classes.button} onClick={() => handleRes('pmb', 0)}>B. I was exceptionally busy this week.</div>
                </div>
