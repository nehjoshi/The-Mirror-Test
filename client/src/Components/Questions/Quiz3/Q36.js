...
const Quiz3_36 = () => {
    ...
    const handleRes = (type, ans) => {
        ...
        const data = { type, value: ans, result, done: false, email: localStorage.getItem("email"), qno: 36 }
        ...
        <Grid container className={classes.wrapper}>
            <Grid className={classes.box} ref={mainRef}>
                ...
                <div className={classes.buttonWrapper}>
                    <div className={classes.button} onClick={() => handleRes('psg', 0)}>A. Everyone was friendly.</div>
                    <div className={classes.button} onClick={() => handleRes('psg', 1)}>B. I was friendly.</div>
                </div>
