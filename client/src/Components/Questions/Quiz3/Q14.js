...
const Quiz3_14 = () => {
    ...
    const handleRes = (type, ans) => {
        ...
        const data = {type, value: ans, result, done: false, email: localStorage.getItem("email"), qno: 14}
        ...
        <Grid container className={classes.wrapper}>
            <Grid className={classes.box} ref={mainRef}>
                ...
                <div className={classes.buttonWrapper}>
                    <div className={classes.button} onClick={() => handleRes('pmg', 0)}>A. My broker decided to take on something new.</div>
                    <div className={classes.button} onClick={() => handleRes('pmg', 1)}>B. My broker is a top-notch investor.</div>
                </div>
