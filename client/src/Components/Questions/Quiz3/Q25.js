...
const Quiz3_25 = () => {
    ...
    const handleRes = (type, ans) => {
        ...
        const data = { type, value: ans, result, done: false, email: localStorage.getItem("email"), qno: 25 }
    ...
    return loading ? (
        ...
        <Grid container className={classes.wrapper}>
            <Grid className={classes.box} ref={mainRef}>
                <h1 className={classes.heading}>Question 25</h1>
                ...
                <div className={classes.buttonWrapper}>
                    <div className={classes.button} onClick={() => handleRes('psb', 1)}>A. I don't put enough thought into things like that.</div>
                    <div className={classes.button} onClick={() => handleRes('psb', 0)}>B. He/she has very picky tastes.</div>
                </div>
