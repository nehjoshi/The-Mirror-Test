...
const Quiz3_11 = () => {
    ...
    const handleRes = (type, ans) => {
        ...
        const data = {type, value: ans, result, done: false, email: localStorage.getItem("email"), qno: 11}
    ...
    return loading ? (
        ...
        <Grid container className={classes.wrapper}>
            <Grid className={classes.box} ref={mainRef}>
                <h1 className={classes.heading}>Question 11</h1>
                <p className={classes.text} style={{ marginTop: '30px' }}>
                You stop a crime by calling the police.
                </p>
                <div className={classes.buttonWrapper}>
                    <div className={classes.button} onClick={() => handleRes('psg', 0)}>A. A strange noise caught my attention.</div>
                    <div className={classes.button} onClick={() => handleRes('psg', 1)}>B. I was alert that day.</div>
                </div>
