...
const Quiz3_20 = () => {
    ...
    const handleRes = (type, ans) => {
        ...
        const data = { type, value: ans, result, done: false, email: localStorage.getItem("email"), qno: 20 }
        ...
        <Grid container className={classes.wrapper}>
            <Grid className={classes.box} ref={mainRef}>
                ...
                <div className={classes.buttonWrapper}>
                    <div className={classes.button} onClick={() => handleRes('pmb', 1)}>A. He/she is always nagging me.</div>
                    <div className={classes.button} onClick={() => handleRes('pmb', 0)}>B. He/she was in a hostile mood.</div>
                </div>
