...
const Quiz3_15 = () => {
    ...
    const handleRes = (type, ans) => {
        ...
        const data = {type, value: ans, result, done: false, email: localStorage.getItem("email"), qno: 15}
        ...
        <Grid container className={classes.wrapper}>
            <Grid className={classes.box} ref={mainRef}>
                ...
                <div className={classes.buttonWrapper}>
                    <div className={classes.button} onClick={() => handleRes('pmg', 0)}>A. I was feeling unbeatable.</div>
                    <div className={classes.button} onClick={() => handleRes('pmg', 1)}>B. I train hard.</div>
                </div>
